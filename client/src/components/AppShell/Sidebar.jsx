...
function NavButton({ id, label, icon, activePage, setActivePage }) {
...
export default function Sidebar() {
  ...
  return (
    <nav className="fixed left-0 top-14 bottom-0 w-[220px] bg-slate-900 border-r border-slate-700 flex flex-col z-30">
      <div className="pt-4 pb-2 px-3 space-y-0.5 flex-1 overflow-y-auto">
        {NAV_ITEMS.map((item) => (
          <NavButton key={item.id} {...item} activePage={activePage} setActivePage={setActivePage} />
        ))}
      </div>
